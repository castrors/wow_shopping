...
import 'package:wow_shopping/features/wishlist/providers/select_items_notifier.dart';
          ...
          children: [
            TopNavBar(
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    ref.read(selectItemsProvider.notifier).toggleSelectAll();
                  },
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Padding(
                      ...
                      child: WishlistItem(
                        ...
                        onToggleSelection:
                            ref.read(selectItemsProvider.notifier).setSelected,
                      ),
                    );
                  },
                ),
